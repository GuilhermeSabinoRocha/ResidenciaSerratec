...
public class Gerente extends Administracao  {
	...
	public static void relContasGerenciadas(Conta logada, List<Object> numeroAgencias) throws IOException
	{
		int contador = 0;
		/*
		...
		System.out.println("|                  Existem " + contador + " agencias gerenciadas                      |");
