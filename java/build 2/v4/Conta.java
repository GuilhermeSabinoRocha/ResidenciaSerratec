...
public abstract class Conta {
	...
	public static boolean movimentacoes(boolean sair,long c, Conta logada, Map<Long, Conta> mapContas, Map<Integer, Conta> mapContasNumeroConta)
	{
		sair = false;
		...
		do {
			...
			case 1:
				...
				if (verificaSairDoSegundoMenu(sair)) {
	...
	public static boolean verificaSairDoSegundoMenu(boolean sair) {
