...
public abstract class Conta {
	...
	public static boolean movimentacoes(long c, Conta logada, Map<Long, Conta> mapContas, Map<Integer, Conta> mapContasNumeroConta)
	{
		boolean sair = false;
	...
	public static void relRendimentosPoup(Conta logada) throws IOException
	{
		...
		switch (op) {
		case 1:
			double simulacao = logada.getSaldo()*1.0003;
			System.out.println(simulacao);
			SistemaInterno.saidaRelRendimentosPoup(simulacao,"7 dias");
			break;
		case 2:
