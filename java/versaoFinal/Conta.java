		...
		if (verificaValor(valorASacar) && valorASacar <= logada.getSaldo() && logada.getTipoConta().equals("Corrente")) {
			...
			try{
				  ...
				  logada.saldo -= 0.1;
					...
					out.write("Saque de R$ " + appUtil.formataMoeda(valorASacar) + " efetuado. \n");
...
if (verificaValor(valorASacar) && valorASacar <= logada.getSaldo() && logada.getTipoConta().equals("Corrente")) {
	...
	try{
		  ...
		  logada.saldo -= 0.1;
			...
			out.write("Depósito de R$ " + appUtil.formataMoeda(valorASacar) + " efetuado. \n");
			out.write("Saldo Atual: \n");
			out.write("R$" + appUtil.formataMoeda(logada.getSaldo()) + "\n\n");
				...
				{											
					...
					try{
						  ...
						  logada.tarifacao += 0.2;
							...
							out.write("Transferência de R$ " + appUtil.formataMoeda(transfValor) + " efetuado. \n");
							out.write("Saldo Atual: \n");
							out.write("R$" + appUtil.formataMoeda(logada.getSaldo()) + "\n\n");
