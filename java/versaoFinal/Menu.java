...
public class Menu {
	...
	public static void menuConta(Usuario usuarioLogado, Conta contaLogada, Map<Long, Conta> mapContas, List<Object> numeroAgencias, Map<Integer, Conta> mapContasNumeroConta) throws IOException, InterruptedException {
		Scanner scan = new Scanner(System.in);
		...
		while(true) {
			...
			System.out.println("|_____________________________________________________________________________________|");
			System.out.println("|                                                                                     |");
			System.out.println("|   [1] Movimentacoes         [2] Relatorios        [3] Seguro        [4] Sair        |");
			System.out.println("|_____________________________________________________________________________________|");
			...
			switch (input) {
				...
				case 2:					
				 ...
				 case 3:
	                    menuSeguro(usuarioLogado, contaLogada, mapContas, numeroAgencias, mapContasNumeroConta);
	                    break;
                case 4:
	                    menuSair();
	                    break;
	...
	public static void menuMovimentacoes(Usuario usuarioLogado, Conta contaLogada, Map<Long, Conta> mapContas, List<Object> numeroAgencias, Map<Integer, Conta> mapContasNumeroConta) throws IOException, InterruptedException {
		Scanner scan = new Scanner(System.in);
	...
	public static void relatorioDeUsuarioCorrente(Usuario usuarioLogado, Conta contaLogada) throws IOException, InterruptedException 
	{
		Scanner scan = new Scanner(System.in);
	...
	public static void relatorioDeUsuarioPoupanca(Usuario usuarioLogado, Conta contaLogada, Map<Long, Conta> mapContas, List<Object> numeroAgencias, Map<Integer, Conta> mapContasNumeroConta) throws IOException, InterruptedException
	{
		System.out.println("|_____________________________________________________________________________________|");
		System.out.println("|                                                                                     |");
	...
	public static void relatorioDaAdiministracao(Usuario usuarioLogado, Conta contaLogada, Map<Long, Conta> mapContas, 
			List<Object> numeroAgencias, Map<Integer, Conta> mapContasNumeroConta) throws IOException, InterruptedException
	{
...
*/
	...
	public static void menuNovaOp(Usuario usuarioLogado, Conta contaLogada, Map<Long, Conta> mapContas, List<Object> numeroAgencias, Map<Integer, Conta> mapContasNumeroConta) throws IOException, InterruptedException {
        Scanner scan = new Scanner(System.in);
	...
	public static void menuSeguro(Usuario usuarioLogado, Conta contaLogada, Map<Long, Conta> mapContas, List<Object> numeroAgencias, Map<Integer, Conta> mapContasNumeroConta) throws InterruptedException, IOException {
        Scanner scan = new Scanner(System.in);
        ...
        System.out.println("|=====================================================================================|");
        System.out.println("|                                                                                     |");
        System.out.println("|   CONTRATACAO - Apolice para " + usuarioLogado.getNome() + "                        |");
        System.out.println("|_____________________________________________________________________________________|");
        System.out.println("|                                                                                     |");
        ...
        if (confSeg.equals("S") || confSeg.equals("s")) {
            if(SeguroVida.contrata(valSeg, usuarioLogado, contaLogada) == true) {
                ...
                System.out.println("|   Ocorreu um erro ao tentar contratar o seguro. Saldo insuficiente.                 |");
                System.out.println("|_____________________________________________________________________________________|");
                System.out.println("|                                                                                     |");
